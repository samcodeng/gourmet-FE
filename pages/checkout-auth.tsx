            ...
            <div className="col-md-6 pr-50">
                    ...
                    <div key={index} className="addressSmall">
                      ...
                      <div className="form-check">
                        <input
                          ...
                          checked={
                            selectedAddress?.id == item.id ? true : false
                          }
                        />
                      </div>
                    </div>
              ...
              {newAddress && (
                <>
                  ...
                  <div className="remember" style={{ marginBottom: 30 }}>
                    <div
              ...
              {user.jwt && (
                <div className="col-md-6">
                  <button
                    className="p-btn p-btn1 w-full"
                    onClick={() => setNewAddress(!newAddress)}
                  >
                    <span>
                      {!newAddress ? "Use New Address" : "Use Saved Address"}
                    </span>
                  </button>
                </div>
              )}
