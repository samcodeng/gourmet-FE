      ...
      <div className="navigation-wrapper">
        <div ref={sliderRef} className="keen-slider">
          <div className="keen-slider__slide slide2 number-slide1">
            <Review name="Okezie J. Atani" />
          </div>
          <div className="keen-slider__slide slide2 number-slide2">
            <Review name="Abiola Bisi" />
          </div>
          <div className="keen-slider__slide slide2 number-slide3">
            <Review name="Moses Peters" />
          </div>
          <div className="keen-slider__slide slide2 number-slide4">
            <Review name="Nnana Leonardo" />
          </div>
          <div className="keen-slider__slide slide2 number-slide5">
            <Review name="Tolu Afolabi" />
          </div>
        </div>
